...
public enum SuccessCode implements ResponseCode {
    ...
    PROFILE_UPDATE_SUCCESS(200, "M-S002", "프로필 정보가 성공적으로 저장되었습니다."),
    ...
    APPLICANT_DECISION_SUCCESS(200, "P-S003", "지원자 상태가 변경되었습니다."),
    PARTY_UPDATE_SUCCESS(200, "P-S004", "파티 정보가 성공적으로 수정되었습니다."),
    PARTY_CANCEL_SUCCESS(200, "P-S005", "파티 모집이 취소되었습니다.")
    ;
